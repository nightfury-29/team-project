...
public class FlightApiClient implements FindFlightApiAccessInterface {
    ...
    public List<Flight> search(String originLocationCode,
        ...
        List<Flight> result = searchFlights(
                originLocationCode,
    ...
    private static List<Flight> searchFlights(String originLocationCode,
                                              String destinationLocationCode,
                                              String departureDate,
                                              int adults,
                                              boolean nonStop) {
        ...
        try {
            ...
            try (Response offersResponse = client.newCall(offersRequest).execute()) {
                ...
                JSONObject dictAircraft = root.optJSONObject("dictionaries") != null
                        ? root.getJSONObject("dictionaries").optJSONObject("aircraft")
                        : null;
